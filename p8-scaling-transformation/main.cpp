 ...
 *
 * References:
 * 1.   ogldev.org/www/tutorial08/tutorial08.html
 ...
 * 
 * Note:
 * This program does the same as the program in part 5 of this repository.
 * However, it is done through matrix transformation.
 */
