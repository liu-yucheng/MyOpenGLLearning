 ...
 *
 * References:
 * 1.   ogldev.org/www/tutorial06/tutorial06.html
 * 2.   glm.g-truc.net/0.9.9/api/modules.html
 * 
 * Intro:
 * A C++ (with OpenGL) program that shows a large red triangle moving left and
 * right.
 */
...
static void display() {
    /* Speed of the rendered object's movement. */
    static float const moveSpeed = 0.001f;
    /* Count of moves of the rendered object. */
    ...
    // Make the object's X position changes between -1.0 and 1.0
    worldVal[3][0] = sinf(moveSpeed * moveCount);
